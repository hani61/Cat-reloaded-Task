...
const Endorsement = ({quote, image, name, job,link}) => {
  return (
    <div className="w-full ">
      <img src={bg} className="object-cover w-full"/>
      <img src={quoteImg} className="relative bottom-60 float-end mr-32 z-0"/>
      ...
      <div className="flex justify-normal h-fit flex-col w-full">
          ...
          <img src={image} className="rounded-full self-center relative w-36 h-36 bottom-44"/>
          <a href={link}>
