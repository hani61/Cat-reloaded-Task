  ...
  return (
    <div className="w-full h-fit flex mt-12 ">
      <div className="w-2/5 p-10 ml-10"> 
        <img src={aboutImg} className="object-contain rounded-2xl"/>
      </div>
    ...
    <div className="w-1/2 justify-around gap-7 flex">  
      <button className="rounded-full border border-black bg-black text-white px-5 py-3 sm:py-3 sm:px-7 text-lg hover:bg-white hover:text-black">Hire Me</button>
     <button className="rounded-full border border-black  text-black px-5 py-3 sm:py-3 sm:px-7 text-lg hover:bg-black hover:text-white"><a href="https://drive.google.com/file/d/1hFPdu59qgkkO1hEkvcRS5PYctlshVUGN/view?usp=sharing">See My Resume</a></button>
    </div>
     </div>
    </div>
  )
